...
<div id="<?php echo esc_attr( $slider_id ); ?>" class="slider<?php echo ( $is_home ) ? ' slider-home' : ''; ?>">
	...
	foreach ( $slider_group as $slide ) {
		...
		$text_section = sprintf('<div class="slick-slide__title-wrap"><div class="slick-slide__title-inner-wrap"><div class="slick-slide__pretitle">%s</div><div class="slick-slide__title">%s</div><div class="slick-slide__subtitle">%s</div><div class="slick-slide__button">%s</div></div></div>',
				$pretitle,
				$title,
				$subtitle,
				$button
